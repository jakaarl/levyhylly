...
public class ArtistDao extends JdbcDaoSupport {
	...
	private static final String FIND_BY_NAME_QUERY = "SELECT id, name FROM artist WHERE name "
	...
	public Artist loadArtist(Long id) throws DataAccessException {
		return getJdbcTemplate().queryForObject(LOAD_QUERY,
				ArtistRowMapper.INSTANCE, new Object[] { id });
	}
	
	public List<Artist> findArtistsByName(String name)
			throws DataAccessException {
		return getJdbcTemplate().query(FIND_BY_NAME_QUERY,
				ArtistRowMapper.INSTANCE, new Object[] { name });
	}
	
	public List<Artist> findArtistsByNameLike(String name)
			throws DataAccessException {
		...
		return getJdbcTemplate().query(FIND_BY_NAME_LIKE_QUERY,
				ArtistRowMapper.INSTANCE, new Object[] { likeifiedName });
	}

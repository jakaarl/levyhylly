  ...
  <body ng-app="levyhylly">
    ...
    <p>
      <form id="albumForm" action="saveAlbum" method="POST">
        ...
        <input type="text" name="artistName" size="30" maxLength="128"<c:if test="${not empty artistId}"> readonly</c:if> value="<c:out value="${artistName}"></c:out>" required/><br/>
        <label for="name"><fmt:message key="album.nameLabel"/></label>
        <input type="text" name="name" size="30" maxLength="128" value="<c:out value="${album.name}"></c:out>" required/><br/>
